    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
     try {
        Class.forName ("com.mysql.cj.jdbc.Driver");
            ...
            if((phoneNum.getText() == null ? "" == null :phoneNum.getText().equals("")) || (nAme.getText() == null ? "" == null :nAme.getText().equals(""))){
               JOptionPane.showMessageDialog
        (null, "Cellphone number and Name must be provided by the Client...","System Message",JOptionPane.INFORMATION_MESSAGE);     
            }   
            else{
                //st.executeUpdate("INSERT into logbook_tbl(" + "num,guestname,email,date,time,roomtype,numperson,checkin,checkout,roomnum" + ") VALUES ('" +phoneNum.getText() + " ',' " +nAme.getText() + "','" +eMail.getText() + "','"+dAte.getText()+ "','"+tIme.getText()+"','" +(String)kwartoType.getSelectedItem()+"','"+noPerson.getText()+"','"+checkIn.getText()+"','"+checkOut.getText()+"','"+roomNum.getText()+ "','");
                st.executeUpdate("INSERT INTO logbook_tbl (" + "num,guestname,email,date,time,roomtype,numperson,checkin,checkout,roomnum" + ") VALUES ('" + phoneNum.getText() + "','"+ nAme.getText() + "','" + eMail.getText() + "','" + dAte.getText() + "','"+ tIme.getText() + "','"+(String)kwartoType.getSelectedItem()+"','");
                JOptionPane.showMessageDialog(null, "Reservation successfully saved!","System Message",JOptionPane.INFORMATION_MESSAGE);
            }
     }
