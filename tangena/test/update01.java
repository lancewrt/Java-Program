 ...
 * @author lance
 */
public class update01 extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(idField.getText().equals("") || passwordField.getText().equals("") || surnameField.getText().equals("") || firstnameField.getText().equals("")){
                ...
                st.executeUpdate("UPDATE students SET  surname= '"+surnameField.getText()+"',firstname= '"+firstnameField.getText()+"', birthday= '"+birthdayField.getText()+"',gender= '"+(String)genderComb.getSelectedItem()+"'Where id = '"+ID+"' AND password = '"+pass+"' ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(update01.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
