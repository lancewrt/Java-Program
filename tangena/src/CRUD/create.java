    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(idField.getText().equals("") || passwordField.getText().equals("") || surnameField.getText().equals("") || firstnameField.getText().equals("")){
                ...
                st.executeUpdate("INSERT INTO students (" + "id,password,surname,firstname,birthday,gender" + ") VALUES ('" + idField.getText() + "','"+ passwordField.getText() + "','" + surnameField.getText() + "','" + firstnameField.getText() + "','"+ birthdayField.getText() + "','"+(String)genderComb.getSelectedItem()+ " ')");
            ...
            JOptionPane.showMessageDialog(null, "ACCOUNT ALREADY EXISTED!","System Message",JOptionPane.ERROR_MESSAGE);
            idField.setText("");
